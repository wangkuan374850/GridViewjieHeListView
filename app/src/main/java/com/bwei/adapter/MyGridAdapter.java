...
public class MyGridAdapter extends BaseAdapter {
    ...
    public MyGridAdapter(Context context, ArrayList<MyGridView> ls1) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        ImageView iv = (ImageView) inflate.findViewById(R.id.grid_iv);
        TextView tv = (TextView) inflate.findViewById(R.id.grid_tv);
